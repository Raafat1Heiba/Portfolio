...
export const projects = [
  {
    title: "Cryptoverse",
    description:
      "Designed entirely in react using Ant Design. It is a cryptocurrency website that displays the latest statistics of the most popular cryptocurrencies. Users can view the top 10 cryptocurrencies their exchanges rate and all the news related to them. This application is powered by RAPID API.",
    image: crypto,
  ...
  },
  {
    title: "TV Show",
    description:
      "A web application that is based on external API TVmaze. This website lets users enjoy TV series and movies. Users can also like and comment on each movie or show and the number of comments and likes will be displayed and increased accordingly.",
    image: tvmaze,
  ...
  },
  {
    title: "Feetness",
    description:
      "This website is designed entirely in React using material UI. The fitness application lets users search for different exercises based on body parts. It also shows similar exercises and displays their YouTube videos.",
    image: feetness,
  ...
  },
  {
    ...
    description:
      "This is my portfolio. A complete mobile-first website that features all my projects, skills, and ambitions. It is written in modern React using functional components, Material UI, and Styled components.",
    image: ndikumana,
  ...
  },
  {
    title: "To-do List",
    description:
      'About "To-do list" is a tool that helps to organize your day. It simply lists the things that you need to do and allows you to mark them as complete.',
    image: todolist,
  ...
  },
  {
    title: "Filmpire",
    description:
      "This website is a film collection app, it lets users fetch a desired film and it will display it in a nice grid container. It is using an API and fetch the data using react",
    image: filmpire,
  ...
  },
  {
    title: "Awesome Books",
    description:
      "This is a book collection website that let users pick a book from a collection of books.",
    image: awesome,
    tags: ["JavaScript", "HTML5", "CSS3", "webpack"],
  ...
  },
  {
    title: "Portfolio",
    description:
      "Hi! My name is NDIKUMANA ISAIE, I am a front-end developer. I have experience in HTML5, CSS3, and JAVASCRIPT. Currently> a full-time student at Microverse to become a Full Stack Web developer. This is my portfolio website which includes all my experience and projects that I have done before",
    image: porto1,
...
export const timeLineData = [
  { year: 2022, text: "Introduction to programming" },
  {
    year: 2024,
    text: " Building Angular, React  applications",
  },
];

export const accomplishment = [
  { number: 9, text: "Repositories" },
  { number: 90, text: "Contributions" },
