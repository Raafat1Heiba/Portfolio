...
const Technologies = () => (
  <Slide direction="up" fraction={0} triggerOnce={true}>
    <Box id="technologies" color="#444f5a">
      <Typography variant="h3" mt="50px" mb="46px" color="#444f5a">
        Technologies
      </Typography>
      ...
      >
        I've worked with a range of Front-End and Back-End technologies in the
        web development world. I have mastered intermediate and advanced topics
        in full-stack development (including Angular, React, NextJS, UI/UX, Git,
        NestJS, Vue,) while building multiple full-stack projects both
      ...
      >
        ...
        >
          <Typography
            sx={{ mt: 4, mb: 2, textAlign: { lg: "center" } }}
            color="#0564bd"
            variant="h4"
            component="div"
          >
